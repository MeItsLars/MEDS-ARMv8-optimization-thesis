...
A very crude minimum cycle bound on the naive algorithm (see Algorithm \ref{alg:naivematrixmultiplication}) can be established by counting the number of arithmetic operations required:
\begin{itemize}
      ...
      \For{$r \gets 0$ to $m$}
        ...
        \For{$r_2 \gets r+1$ to $m$}
          \For{$c \gets r$ to $n$}
            ...
            \State $A[r2][c] \gets (4093 + A[r2][c] - $v$) \mod 4093$
          \EndFor
        \EndFor
      \EndFor
    \EndFunction
