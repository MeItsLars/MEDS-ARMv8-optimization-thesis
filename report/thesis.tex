...
% REMAINING TODO SELF
% Include a discussion which looks back at the research questions
% Grammar check entire thing
% Check all citations (specifically URLs, they are not always included)
...
% Assuming I get the Apple device in time, I will also benchmark theoptimized MEDS implementation on that CPU. Explore the speedup possibilitieson other ARM-based CPUs (such as Apple M1) which can possibly utilize largercaches and/or the better KECCAK primitives possible on Armv8.2-A (Cortex-A72uses Armv8-A). See: \url{https://developer.arm.com/documentation/100076/0100A64-Instruction-Set-Reference/A64-Cryptographic-AlgorithmsA64-Cryptographic-instructions?lang=en}
% In high level-v8, change 13-bit reduction to a simple freeze.
...
\todo[inline]{Add a section containing a list of the best known attack(s) on MEDS (or the underlying problem). Reference MEDS paper on this information.}
...
\todo[inline]{Include a section that compares the performance of MEDS to similar schemes.}

\section{Discussion}
\todo[inline]{Answer the research questions.}
