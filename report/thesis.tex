...
% Move this table down a bit because it helps with formatting
\begin{table}
  \centering
...
% Move these tables up a bit because they help with formatting
\begin{algorithm}
...
% [SUGGEST PAGEBREAK FOR FORMATTING]
\pagebreak
...
% Weird samepage to force formatting
\begin{samepage}
\begin{algorithm}
