...
\begin{table}
  ...
  \begin{tabular}{llrrr}
    ...
    \toprule
    Matrix Mult. & $A$: $2 \times k \quad B$: $k \times k$ & 1325 & 743.75 & $\times 1.78$\\
    Matrix Mult. & $A$: $n \times k \quad B$: $k \times m$ & x & x & x\\
    \midrule
    Matrix Syst. & $A$: $m \times m$ & x & x & x\\
    \midrule
    System Solving & $G$: $nm \times 2m$ & x & x & x\\
    \bottomrule
  \end{tabular}
  %
  }
