...
\todo[inline]{Check if splitting 16-bit values into two 8-bit values is faster.}

\section{Hash Structure Optimization}
\label{sec:hashfunctionoptimization}
\todo[inline]{Leuke plaatjes (sequence vs parallel)}
