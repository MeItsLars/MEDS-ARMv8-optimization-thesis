...
% REMAINING TODO SELF
% Check all figures and tables for proper captions
% Check capitalization of section names
% Check formatting of enumerate items (;;;.)
...
% (such as other CPU architecturer, analysing memory and energy usage, etc.)
\section{Additional research topics}

% Analyse and optimize memory and power usage of the (optimized) MEDS implementation.
...
% Implement the optimized MEDS implementation on other CPU architectures that support SIMD instructions, such as AVX512.
